                ...
                <div class="flex flex-wrap justify-between w-full gap-4 sm:flex-nowrap">
                    <div class="basis-full md:basis-1/3">
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <select name="kategori_kode" id="kategori_kode"
                                ...
                                @foreach ($kategori as $k)
                                    <option value="{{ $k->kode_kategori }}" {{ $k->kode_kategori == (old('kategori_kode') ?? $bus->kategori_kode) ? 'selected' : '' }}>{{ $k->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <x-input-dashboard type="text" name="kapasitas_solar" id="kapasitas_solar" placeholder="masukkan kapasitas solar" value="{{ old('kapasitas_solar') ?? $bus->kapasitas_solar }}" />
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <x-input-dashboard type="text" name="jumlah_kursi" id="jumlah_kursi" placeholder="masukkan jumlah kursi" value="{{ old('jumlah_kursi') ?? $bus->jumlah_kursi }}" />
                    ...
                    <div class="basis-full md:basis-1/3">
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <select name="status_bus_kode" id="status_bus_kode"
                                ...
                                @foreach ($status_bus as $s)
                                    <option value="{{ $s->kode_status }}" {{ $s->kode_status == (old('status_bus_kode') ?? $bus->status_bus_kode ) ? 'selected' : '' }}>{{ $s->deskripsi }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <x-input-dashboard type="text" name="kecepatan" id="kecepatan" placeholder="masukkan kecepatan bus" value="{{ old('kecepatan') ?? $bus->kecepatan }}" />
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <x-input-dashboard type="text" name="harga_sewa" id="harga_sewa" placeholder="masukkan harga sewa" value="{{ old('harga_sewa') ?? $bus->harga_sewa }}" />
                    ...
                    <div class="basis-full md:basis-1/3">
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <x-input-dashboard type="text" name="nama_bus" id="nama_bus" placeholder="masukkan nama bus" value="{{ old('nama_bus') ?? $bus->nama_bus }}" />
