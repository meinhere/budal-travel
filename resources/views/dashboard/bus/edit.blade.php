                ...
                <div class="flex flex-wrap justify-between w-full gap-4 sm:flex-nowrap">
                    <div class="basis-full md:basis-1/3">
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            <label for="kategori_kode" class="text-xl font-semibold text-secondary-base">Kategori Kode
                                Bus</label>
                            <select name="kategori_kode" id="kategori_kode"
                                ...
                                @foreach ($kategori as $k)
                                    <option value="{{ $k->kode_kategori }}"
                                        {{ $k->kode_kategori == $bus->kategori_kode ? 'selected' : '' }}>
                        ...
                        {{-- Kapasitas Solar --}}
                        <div class="flex flex-col gap-2 mt-5">
                            <label for="kapasitas_solar" class="text-xl font-semibold text-secondary-base">Kapasitas
                                Solar</label>
                            <input type="text" name="kapasitas_solar" id="kapasitas_solar"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5"
                                placeholder="masukkan kapasitas solar"
                                value="{{ old('kapasitas_solar') ?? $bus->kapasitas_solar }}">
                        </div>

                        {{-- Jumlah Kursi --}}
                        <div class="flex flex-col gap-2 mt-5">
                            <label for="jumlah_kursi" class="text-xl font-semibold text-secondary-base">Jumlah
                                Kursi</label>
                    ...
                    <div class="basis-full md:basis-1/3">
                        {{-- Status Bus --}}
                        <div class="flex flex-col gap-2 mt-5">
                            <label for="status_bus_kode" class="text-xl font-semibold text-secondary-base">Status
                                Bus</label>
                            <select name="status_bus_kode" id="status_bus_kode"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5 ">
                                @foreach ($status_bus as $s)
                                    <option value="{{ $s->kode_status }}"
                                        {{ $s->kode_status == $bus->status_bus_kode ? 'selected' : '' }}>
                                        {{ $s->deskripsi }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <input type="text" name="kecepatan" id="kecepatan"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5"
                                placeholder="masukkan kecepatan bus" value="{{ old('kecepatan') ?? $bus->kecepatan }}">
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <input type="text" name="harga_sewa" id="harga_sewa"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5"
                                placeholder="masukkan harga sewa" value="{{ old('harga_sewa') ?? $bus->harga_sewa }}">
                        </div>
                    </div>
                    ...
                    <div class="basis-full md:basis-1/3">
                        ...
                        <div class="flex flex-col gap-2 mt-5">
                            ...
                            <input type="text" name="nama_bus" id="nama_bus"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5"
                                placeholder="masukkan nama bus" value="{{ old('nama_bus') ?? $bus->nama_bus }}">
                        </div>
                    </div>
                </div>
